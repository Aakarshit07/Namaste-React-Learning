      ...
      <div className="flex justify-between items-center border-b-2 border-gray-300 p-4">
        ...
        <div className="">
          <ul className="flex justify-between items-center gap-4 p-4">
            {/* <li className="font-semibold text-gray-600 p-2 rounded-md hover:bg-neutral-400/90 hover:text-white hidden md:block" ><Link to="/cart">Cart - {cartItems.length} Items</Link></li> */}
            ...
            <li className="font-semibold text-gray-600 p-2 rounded-md hover:bg-neutral-400/90 hover:text-white text-lg md:text-md border-2 md:border-none"><Link to="/cart">Cart {cartItems.length} Items</Link></li>
